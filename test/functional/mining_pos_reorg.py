...
class ReorgStakeTest(NakamTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected NAKAM supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check NAKAM supply at the beginning
        # ------------------------------------------
        # NAKAM supply: block rewards minus burned fees for minting
        ...
        # Verify that NAKAM supplies were properly updated after the spends and reorgs
        self.log.info("Check NAKAM supply...")
