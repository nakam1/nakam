...
/* Nakam GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nakam"
#define QAPP_ORG_DOMAIN "nakam.org"
#define QAPP_APP_NAME_DEFAULT "Nakam-Qt"
#define QAPP_APP_NAME_TESTNET "Nakam-Qt-testnet"
