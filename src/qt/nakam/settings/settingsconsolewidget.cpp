...
#include "qt/nakam/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/nakam/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the NAKAM RPC console.") + "<br>" +
