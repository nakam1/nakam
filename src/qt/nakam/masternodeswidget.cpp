...
#include "qt/nakam/masternodeswidget.h"
#include "qt/nakam/forms/ui_masternodeswidget.h"

#include "qt/nakam/qtutils.h"
#include "qt/nakam/mnrow.h"
#include "qt/nakam/mninfodialog.h"
#include "qt/nakam/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/nakam/optionbutton.h"
#include <iostream>
#include <fstream>
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:32324 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
