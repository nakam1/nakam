...
#include "qt/nakam/forms/ui_topbar.h"
#include "qt/nakam/loadingdialog.h"
#include "qt/nakam/lockunlock.h"
#include "qt/nakam/qtutils.h"
#include "qt/nakam/receivedialog.h"
                                                        ...
                                                        ui(new Ui::TopBar)
{
    ...
    ui->pushButtonConf->setButtonText("nakam.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open nakam.conf with default application"));
}
