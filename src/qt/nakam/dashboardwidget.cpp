...
#include "qt/nakam/forms/ui_dashboardwidget.h"
#include "qt/nakam/sendconfirmdialog.h"
#include "qt/nakam/txrow.h"
    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of NAKAM earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 NAKAM");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("NAKAM")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair NAKAM
