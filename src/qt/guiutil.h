...
/** Utility functions used by the Nakam Qt UI.
 */
namespace GUIUtil
{
...
// Render NAKAM addresses in monospace font
...
// Parse "nakam:" URI into recipient object, return true on successful parsing
