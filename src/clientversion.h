...
#error Client version information missing: version is not defined by nakam-config.h or in any other way
#endif
...
/**
 * nakamd-res.rc includes this file, but it cannot cope with real c++ code.
