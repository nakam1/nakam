...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NAKAM features */
        {"nakam", "listmasternodes", &listmasternodes, true },
        {"nakam", "getmasternodecount", &getmasternodecount, true },
        {"nakam", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"nakam", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"nakam", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"nakam", "masternodecurrent", &masternodecurrent, true },
        {"nakam", "startmasternode", &startmasternode, true },
        {"nakam", "createmasternodekey", &createmasternodekey, true },
        {"nakam", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"nakam", "listmasternodeconf", &listmasternodeconf, true },
        {"nakam", "getactivemasternodecount", &getactivemasternodecount, true },
        {"nakam", "getmasternodestatus", &getmasternodestatus, true },
        {"nakam", "getmasternodewinners", &getmasternodewinners, true },
        {"nakam", "getmasternodescores", &getmasternodescores, true },
        {"nakam", "mnsync", &mnsync, true },
        {"nakam", "spork", &spork, true },
...
{
    return "> nakam-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32323/\n";
}
