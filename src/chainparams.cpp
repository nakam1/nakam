...
// Copyright (c) 2021-2022 The Nakam Core Developers
...
{
    const char* pszTimestamp = "01/02/2026 - This is NAKAM Core.";
    const CScript genesisOutputScript = CScript() << ParseHex("04e0037d01c98b8ce9f91c60b571060f684b0d81a6fa4b3b76ec83163a81cb4a5bcc8b78407f7b097c0fcd398a4d30309355fe66190792362e84129f0a7fe1588e") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("00000b94e0fc20bfb54f63fcc57640f19f64be703f720153b7fcc2fd3606c2d3"))
;


static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1769945129, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of
    (0, uint256S("0x00000b94e0fc20bfb54f63fcc57640f19f64be703f720153b7fcc2fd3606c2d3"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256S("0x0000764315a4125d9986fade4e7ccd54fd14ee439b348f2ca3321c23949947a3"));
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1769945129, 42038, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000b94e0fc20bfb54f63fcc57640f19f64be703f720153b7fcc2fd3606c2d3"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e1d14a9b65ef3907b4daf24b7970e25e80c90e4637824f28a88a2bca8ec612b"));
        ...
        consensus.nStakeMinDepthV2 = 101;
        consensus.nTargetTimespan = 40 * 60;
        consensus.nTargetTimespanV2 = 41 * 60;
        ...
        consensus.mBurnAddresses = {
            { "NXXXXXXXXXXXXXXXXXXXXXXXXXXXaPewjL",      0 }, 
        };
        ...
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V2].nActivationHeight      = 602;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MIN_DEPTH_V1].nActivationHeight     = 674;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight                 = 680;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight                  = 710;
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].nActivationHeight       = 504;
        consensus.vUpgrades[Consensus::UPGRADE_P2PKH_BLOCK_SIGNATURES].nActivationHeight = 805;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MIN_DEPTH_V2].nActivationHeight     = 815;
        consensus.vUpgrades[Consensus::UPGRADE_CHECK_WORK_V2].nActivationHeight          = 830;
        consensus.vUpgrades[Consensus::UPGRADE_MASTERNODE_RANK_V2].nActivationHeight     = 1030; 
        ...
        vSeeds.emplace_back(CDNSSeedData("seeder", "seeder.nakamcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed",  "seed.nakamcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed2",  "seed2.nakamcoin.com", true)); 
        vSeeds.emplace_back(CDNSSeedData("node",  "node.nakamcoin.com", true)); 
        vSeeds.emplace_back(CDNSSeedData("node2",  "node2.nakamcoin.com", true)); 
...
public:
    CTestNetParams()
    {
        ...
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // nakam starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        consensus.nCoinbaseMaturity = 100;
        ...
        vSeeds.emplace_back(CDNSSeedData("tseeder", "tseeder.nakamcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("tseed1",  "tseed1.nakamcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("tseed2",  "tseed2.nakamcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("tseed3",  "tseed3.nakamcoin.com", true)); 

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nakam addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet nakam script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nakam BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet nakam BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet nakam BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        genesis = CreateGenesisBlock(1769945130, 198244, 0x1effffff, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000764315a4125d9986fade4e7ccd54fd14ee439b348f2ca3321c23949947a3"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e1d14a9b65ef3907b4daf24b7970e25e80c90e4637824f28a88a2bca8ec612b"));
