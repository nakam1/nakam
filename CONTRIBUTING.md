Contributing to Nakam Core
============================

The Nakam Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nakam-project/nakam/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Nakam Core project, and is not to be
confused with overall Nakam Network Protocol consensus changes.

Whether a pull request is merged into Nakam Core rests with the project merge
...
Patches that change Nakam consensus rules are considerably more involved than
...
Where a patchset proposes to change the Nakam consensus, it must have been
...
The project leader is the release manager for each Nakam Core release.
