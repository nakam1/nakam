...
RESOURCES += src/qt/nakam.qrc src/qt/nakam_locale.qrc

TRANSLATIONS += src/qt/locale/nakam_bg.ts \
                src/qt/locale/nakam_de.ts \
                src/qt/locale/nakam_en.ts \
                src/qt/locale/nakam_es.ts \
                src/qt/locale/nakam_fi.ts \
                src/qt/locale/nakam_fr.ts \
                src/qt/locale/nakam_it.ts \
                src/qt/locale/nakam_ja.ts \
                src/qt/locale/nakam_pl.ts \
                src/qt/locale/nakam_pt.ts \
                src/qt/locale/nakam_ru.ts \
                src/qt/locale/nakam_sk.ts \
                src/qt/locale/nakam_sv.ts \
                src/qt/locale/nakam_vi.ts \
                src/qt/locale/nakam_zh_CN.ts \
                src/qt/locale/nakam_zh_TW.ts
