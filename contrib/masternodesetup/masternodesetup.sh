...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nakam.conf'
CONFIGFOLDER='/root/.nakam'
COIN_DAEMON='nakamd'
COIN_CLI='nakam-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/nakam/NAKAM/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
